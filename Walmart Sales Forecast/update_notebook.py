...
try:
    ...
    target_indices = [idx_eval, idx_model, idx_scale, idx_clean, idx_feat, idx_data]
    if all(idx != -1 for idx in target_indices):
        ...
        print(f"Failed to find all injection points: {target_indices}")
